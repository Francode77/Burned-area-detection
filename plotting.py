...
class FieldPlotter:
    ...
    def plot_firemask(self,image):
        
        mask = Field.get_firemask(image)
    ...
    def plot_active_fire_mask(self,image):
    ...
    def bi_plot_rgb(self, mask, brightness):
